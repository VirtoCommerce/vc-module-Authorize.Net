...
namespace VirtoCommerce.AuthorizeNet.Web.Managers
{
	public class AuthorizeNetMethod : PaymentMethod
	{
		...
		private string _txnKey;
		private string _confirmationUrl;
		private string _thankYouPageRelativeUrl;
		private string _paymentActionType;
		private string _mode;
		private string _sha2Hash;
		...
		public string ApiLogin
		{
			get
			{
				if (_apiLogin == null)
				{
					_apiLogin = Settings.GetSettingValue(_apiLoginStoreSetting, string.Empty);
				}
				return _apiLogin;
			}
		}
		...
		public string TxnKey
		{
			get
			{
				if (_txnKey == null)
				{
					_txnKey = Settings.GetSettingValue(_txnKeyStoreSetting, string.Empty);
				}
				return _txnKey;
			}
		}
		...
		public string SHA5Hash
		{
			get
			{
				if (_sha2Hash == null)
				{
					_sha2Hash = Settings.GetSettingValue(_sha2HashStoreSetting, string.Empty);
				}
				return _sha2Hash;
			}
		}
		...
		private string ConfirmationUrl
		{
			get
			{
				...
				{
					_confirmationUrl = Settings.GetSettingValue(_confirmationUrlStoreSetting, string.Empty);
				}
		...
		private string ThankYouPageRelativeUrl
		{
			get
			{
				if (_thankYouPageRelativeUrl == null)
				{
					_thankYouPageRelativeUrl = Settings.GetSettingValue(_thankYouPageRelativeUrlStoreSetting, string.Empty);
				}
				return _thankYouPageRelativeUrl;
			}
		}
		...
		private string PaymentActionType
		{
			get
			{
				if (_paymentActionType == null)
				{
					_paymentActionType = Settings.GetSettingValue(_paymentActionTypeStoreSetting, string.Empty);
				}
		...
		private string Mode
		{
			get
			{
				if (_mode == null)
				{
					_mode = Settings.GetSettingValue(_modeStoreSetting, string.Empty);
				}
				return _mode;
			}
		}
